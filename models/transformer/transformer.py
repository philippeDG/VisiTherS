...
from models.transformer.attention import MultiheadAttentionRelative
from models.transformer.utilities.misc import get_clones
...
def build_transformer(args):
    return Transformer(
        hidden_dim=256,#args.channel_dim,
        nhead=8,#args.nheads,
        num_attn_layers=6#args.num_attn_layers
    )
